...
<tr height="30"><th><font color="white">작성일</font></th><td align="center"><font color="white">${board.b_reg_date }</font></td></tr>
...
<input type="button" value="글 목록" onclick="location.href='main.do?pageNum=${pageNum}'" />
...
<c:if test = "${!empty list}">
					...
					<tr>
						...
						<c:if test="${l.c_re_level>0 }">	
							<!-- level이 0보다 크면 답변글 -->
								<img src='images/level.gif' width='${l.c_re_level*10 }' height='5'>
								<!-- 답변글의 구분을 10칸씩 표시 -->
